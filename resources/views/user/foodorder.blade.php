...
@endif
<div class="card-body">
<table class="table table-bordered" id="foodorder-datatable">
<thead>
<tr>
<th>Id</th>
<th>Food</th>
...
$('#foodorder-datatable').DataTable({
processing: true,
serverSide: true,
ajax: "{{ url('foodorder-datatable') }}",
columns: [
{ data: 'id', name: 'id' },
{ data: 'food', name: 'food.name' },
{ data: 'price', name: 'food.price' },
