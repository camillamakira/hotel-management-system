...
@section('content')
    ...
    <!-- Breadcrumb Section End -->
        ...
        <!-- Food Details Section Begin -->
        <section class="room-details-section spad">
        <div class="container">
            <div class="row">
                <div class="col-lg-8">
                    <div class="room-details-item">
                        <img src="{{Storage::url($singlefood->photo)}}" alt="">
                        <div class="rd-text">
                            <div class="rd-title">
                            ...
                            <table>
                                <tbody>
                                    <tr>
                                        ...
                                        <td>{{$singlefood->size}}</td>
                                    </tr>
                                    <tr>
                                        <td class="r-o">Quantity:</td>
                                        <td>Max person(s) {{$singlefood->quantity}}</td>
                                    </tr>
                                    <tr>
                                        <td class="r-o">Services:</td>
                                        <td>{{$singlefood->services}}</td>
                                    </tr>
                                </tbody>
                            </table>
